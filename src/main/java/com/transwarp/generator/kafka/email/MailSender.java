...
public class MailSender {
   ...
   * @return
   */
  public MimeMessage getMimeMessage(Session session, String value) throws Exception{
    //创建一封邮件的实例对象
    ...
    //设置邮件主题
    msg.setSubject("HTAP性能测试","UTF-8");
    //设置邮件正文
    msg.setContent(value, "text/html;charset=UTF-8");
    //设置邮件的发送时间,默认立即发送
